    ...
    public class AuditFlowAppService : ApplicationService
    {
        ...
        private async Task<List<AuditFlowRightDetailDto>> FilteTask(long auditFlowId, List<AuditFlowRightDetailDto> list)
        {
            ...
            return list
                ...
                .WhereIf((projectPm == null) || (priceEvaluationStartData != null && priceEvaluationStartData.CreatorUserId != null && priceEvaluationStartData.CreatorUserId != AbpSession.UserId && projectPm.ProjectManager != AbpSession.UserId), p => p.ProcessIdentifier != FinanceConsts.PricingDemandInput || p.IsReset)
