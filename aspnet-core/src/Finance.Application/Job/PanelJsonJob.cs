...
namespace Finance.Job
{
    public class PanelJsonJob : AsyncBackgroundJob<long>, ITransientDependency
    {
        ...
        public PanelJsonJob(PriceEvaluationGetAppService priceEvaluationGetAppService, IRepository<ModelCountYear, long> modelCountYearRepository, IRepository<Gradient, long> gradientRepository, IRepository<Solution, long> solutionRepository, IRepository<PanelJson, long> panelJsonRepository, IUnitOfWorkManager unitOfWorkManager)
        {
