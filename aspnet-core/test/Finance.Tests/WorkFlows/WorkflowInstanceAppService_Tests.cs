...
namespace Finance.Tests.WorkFlows
{
    public class WorkflowInstanceAppService_Tests : FinanceTestBase
    {
        ...
        /// <returns></returns>
        [Fact]
        public async Task GetTaskByUserId_Test()
        {
            var output = await _workflowInstanceAppService.GetTaskByUserId(1);
            output.Items.Count.CompareTo(0);
        }
        ...
        public async Task GetTaskByWorkflowInstanceId_Test()
        {
            ...
            var output = await _workflowInstanceAppService.GetTaskByWorkflowInstanceId(1, 39);
            output.Count.CompareTo(1);
        }
        ...
        /// <returns></returns>
        [Fact]
        public async Task GetTaskCompletedFilter_Test()
        {
            var output = await _workflowInstanceAppService.GetTaskCompletedFilter();
            output.Items.Count.CompareTo(0);
        }
        ...
        /// <returns></returns>
        [Fact]
        public async Task GetTaskCompleted_Test()
        {
            var output = await _workflowInstanceAppService.GetTaskCompleted();
            output.Items.Count.CompareTo(0);
        }
        ...
        /// <returns></returns>
        [Fact]
        public async Task GetTaskCompletedByUserId_Test()
        {
            var output = await _workflowInstanceAppService.GetTaskCompletedByUserId(1, WorkflowState.Running);
            output.Items.Count.CompareTo(0);
        }
        ...
        public async Task GetInstanceHistoryByWorkflowInstanceId_Test()
        {
            ...
            var output = await _workflowInstanceAppService.GetInstanceHistoryByWorkflowInstanceId(1);
            output.Items.Count.CompareTo(2);
        }
        ...
        public async Task GetInstanceHistoryById_Test()
        {
            ...
            var output = await _workflowInstanceAppService.GetInstanceHistoryById(1);
            output.Items.Count.CompareTo(2);
        }
        ...
        public async Task GetInstanceHistorys_Test()
        {
            ...
            var output = await _workflowInstanceAppService.GetInstanceHistorys(1);
            output.Items.Count.CompareTo(2);
        }
        ...
        public async Task GetWorkflowStatus_Test()
        {
            ...
            var output = await _workflowInstanceAppService.GetWorkflowStatus(1);
            output.Count.CompareTo(41);
        }
        ...
        public async Task GetWorkflowInstance_Test()
        {
            ...
            var output = await _workflowInstanceAppService.GetWorkflowInstance(new GetWorkflowInstanceInput { WorkflowState = WorkflowState.Running });
            output.Items.Count.CompareTo(41);
        }
        ...
        public async Task GetEvalDataByNodeInstanceId_Test()
        {
            ...
            var output = await _workflowInstanceAppService.GetEvalDataByNodeInstanceId(39);
            output.Items.Count.CompareTo(0);
        }
        ...
        public async Task GetWorkflowOvered_Test()
        {
            ...
            var output = await _workflowInstanceAppService.GetWorkflowOvered(new GetWorkflowOveredInput { AuditFlowId = 1 });
            output.Items.Count.CompareTo(0);
        }
        ...
        public async Task GetWorkflowDelete_Test()
        {
            ...
            var output = await _workflowInstanceAppService.GetWorkflowDelete(new GetWorkflowOveredInput { AuditFlowId = 1 });
            output.Items.Count.CompareTo(0);
        }
        ...
        public async Task OverWorkflow_Test()
        {
            ...
            await _workflowInstanceAppService.OverWorkflow(new OverWorkflowInput { AuditFlowId = 1 });
        }
        ...
        public async Task ActivateStructBomEval_Test()
        {
            ...
            await _workflowInstanceAppService.ActivateStructBomEval(1);
        }
        ...
        public async Task DeactivateStructBomEval_Test()
        {
            ...
            await _workflowInstanceAppService.DeactivateStructBomEval(1);
        }
        ...
        public async Task ActivateElectronicBomEval_Test()
        {
            ...
            await _workflowInstanceAppService.ActivateElectronicBomEval(1);
        }
        ...
        public async Task DeactivateElectronicBomEval_Test()
        {
            ...
            await _workflowInstanceAppService.DeactivateElectronicBomEval(1);
        }
    }
}
